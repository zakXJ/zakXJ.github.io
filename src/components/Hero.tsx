              ...
              {hero.buttons.map((btn) => (
                <a
                  ...
                  className={btn.variant === "primary"
                    ? "bg-zinc-800 text-white px-6 py-4 rounded-full font-semibold hover:shadow-lg hover:-translate-y-1 hover:shadow-zinc-300 transition-transform duration-300 ease-in-out"
                    : "bg-white border border-zinc-800 text-zinc-800 px-6 py-4 rounded-full font-semibold hover:shadow-lg hover:-translate-y-1 hover:shadow-zinc-300 transition-transform duration-300 ease-in-out"
                  }
                >
                  {btn.label}
                </a>
