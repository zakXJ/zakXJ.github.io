  ...
  return (
    <section className=" w-4/5 mx-auto bg-sk flex flex-col my-20 justify-center text-zinc-900">
      ...
      <div className="grid grid-cols-2 gap-8">
        <div className="relative overflow-clip bg-teal-100 p-16 rounded-3xl border border-zinc-800 group">
        ...
        <div className="relative overflow-clip bg-sky-100 p-16 rounded-3xl border border-zinc-800 group">
        ...
        <div className="relative overflow-clip bg-zinc-100 p-16 rounded-3xl border border-zinc-800 group">
        ...
        <div className="relative overflow-clip bg-white p-16 rounded-3xl border border-zinc-800 group">
