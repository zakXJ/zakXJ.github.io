function Skills() {
  return (
    <section id="skills" className=" w-4/5 mx-auto bg-sk flex flex-col pt-36 justify-center text-zinc-900 dark:text-zinc-100">
      <h1 className="text-5xl font-base mb-10">Skills</h1>
      <div className="grid sm:grid-cols-2 gap-8">
        <div className="relative overflow-clip bg-teal-100 dark:bg-teal-800/30 py-16 rounded-3xl border border-zinc-800 dark:border-zinc-600 group">
        ...
        <div className="relative overflow-clip bg-sky-100 dark:bg-sky-800/30 py-16 rounded-3xl border border-zinc-800 dark:border-zinc-600 group">
        ...
        <div className="relative overflow-clip bg-zinc-100 dark:bg-neutral-800 py-16 rounded-3xl border border-zinc-800 dark:border-zinc-600 group">
        ...
        <div className="relative overflow-clip bg-white dark:bg-neutral-800 py-16 rounded-3xl border border-zinc-800 dark:border-zinc-600 group">
